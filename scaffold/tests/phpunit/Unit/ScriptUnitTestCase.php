...
namespace DrevOps\Scaffold\Tests\Unit;

use PHPUnit\Framework\TestCase;
use DrevOps\Scaffold\Tests\Traits\ArrayTrait;
use DrevOps\Scaffold\Tests\Traits\AssertTrait;
...
abstract class ScriptUnitTestCase extends TestCase {
   ...
   * @var string
   */
  protected static $script = 'sandbox-multipackage';
